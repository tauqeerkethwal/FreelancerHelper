...
{
    public class FreelancerSeedData : CreateDatabaseIfNotExists<FreelancerEntities>
    {
        protected override void Seed(FreelancerEntities context)
        {
            //GetCategories().ForEach(c => context.Categories.Add(c));
            //GetGadgets().ForEach(g => context.Gadgets.Add(g));
            GetEmployeeType().ForEach(g => context.EmployeeTypes.Add(g));
            context.Commit();
        }
        private static List<EmployeeType> GetEmployeeType()
        {
